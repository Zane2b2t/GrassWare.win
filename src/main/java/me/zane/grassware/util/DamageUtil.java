...
public class DamageUtil
    ...
    public static float calculateDamage2(double posX, double posY, double posZ, Entity entity) {
    ...
    public static float calculateDamage(Entity crystal, Entity entity) {
        return DamageUtil.calculateDamage2(crystal.posX, crystal.posY, crystal.posZ, entity);
    }
