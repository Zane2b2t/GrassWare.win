...
public class InventoryUtil
    ...
    public static void switchToHotbarSlot(Class<? extends net.minecraftforge.registries.IForgeRegistryEntry.Impl> clazz, boolean silent) {
    ...
    public static int findHotbarBlock(Class<? extends net.minecraftforge.registries.IForgeRegistryEntry.Impl> clazz) {
        for (int i = 0; i < 9; ++i) {
            Block block;
    ...
    public static int findInventoryBlock(Class<? extends Block> clazz, boolean offHand) {
        AtomicInteger slot = new AtomicInteger();
        slot.set(-1);
        for (Map.Entry<Integer, ItemStack> entry : InventoryUtil.getInventoryAndHotbarSlots().entrySet()) {
    ...
    public static boolean isBlock(Item item, Class<? extends Block> clazz) {
    ...
    public static boolean[] switchItem(boolean back, int lastHotbarSlot, boolean switchedItem, Switch mode, Class<? extends net.minecraftforge.registries.IForgeRegistryEntry.Impl> clazz) {
        ...
        switch (mode) {
            ...
            case SILENT: {
                if (!back && !switchedItem) {
                    ...
                    switchedItemSwitched[0] = false;
                    Quantum.inventoryManager.recoverSilent(lastHotbarSlot);
                }
                switchedItemSwitched[1] = true;
                break;
            }
    ...
    public static int findBlockSlotInventory(Class<Block> clazz, boolean offHand, boolean withXCarry) {
