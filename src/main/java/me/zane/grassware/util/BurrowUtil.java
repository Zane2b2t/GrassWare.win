...
public class BurrowUtil implements Util {
    ...
    public static
    void placeBlock(final BlockPos pos, final EnumHand hand, final boolean rotate, final boolean packet, final boolean isSneaking) {
    ...
    public static int findHotbarBlock(final Class<? extends Block> clazz) {
        for (int i = 0; i < 9; ++i) {
